 ...
 <body>
  <div class="col-lg-18 grid-margin stretch-card"> 
   <div class="card"> 
    ...
    <form class="d-flex align-items-center h-10" action="/company" method="get"> 
     ...
     <table class="table table-hover"> 
      ...
      <tr> 
       ...
       <td><form action="/notice/{{$row->id}}" method="post">
           {{csrf_field()}}
           {{method_field("DELETE")}}
           <button class="btn btn-outline-danger btn-fw ajdel " type="submit">删除</button>
           </form>
           <a href="/notice/{{$row->id}}/edit" class="btn btn-outline-success btn-fw">修改</a>
        </td>
      </tr>
      @endforeach 
      </tbody> 
