...
<html>
 <head></head>
 <script type="text/javascript" charset="utf-8" src="/UEditor/ueditor/ueditor.config.js"></script>
    <script type="text/javascript" charset="utf-8" src="/UEditor/ueditor/ueditor.all.min.js"> </script>
 ...
 <body>
  <div class="card"> 
   <div class="card-body"> 
    ...
    <form class="forms-sample" action="/notice/{{$info->id}}" method="post"> 
     <div class="form-group row"> 
      <label for="exampleInputUsername2" class="col-sm-3 col-form-label"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">标题</font></font></label> 
       ...
       <input type="text" class="form-control" id="exampleInputUsername2" placeholder="标题" name="title" value="{{$info->title}}"/> 
     ...
     <div class="form-group row"> 
      <label for="exampleInputEmail2" class="col-sm-3 col-form-label"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">公告内容</font></font></label> 
        ...
        <script id="editor" name="content" type="text/plain" style="width:900px;height:500px;">{!!$info->content!!}</script>
