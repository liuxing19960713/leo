...
<html>
 ...
 <body>
  <div class="col-12 grid-margin stretch-card">
   <div class="card">
    <div class="card-body">
     <h4 class="card-title">修改回复</h4>
     <form class="forms-sample" action="/recomment/{{$id}}" method="post">
 ...
 echo htmlspecialchars_decode($comment) @endphp
        ...
        <hr>
      <div class="form-group">
       <label for="exampleInputCity1">已回复的内容</label>
        <br>
      <td class="text-danger" style="width: 180px;font-size: 12px;overflow: hidden;color: red;">
 @php
 echo htmlspecialchars_decode($recomment) @endphp
          </td>
      </div>
        <hr>
      ...
      <div class="form-group">
       ...
       <!-- 加载编辑器的容器 -->
      <script id="ue-container" name="recommentedit"  type="text/plain">
      </script>
      </div>
      <button type="submit" class="btn btn-gradient-primary mr-2">提交</button>
      <a class="btn btn-light" href="/recomment">返回</a>
     </form>
    </div>
   </div>
  </div>
